...
echo -e "                                                                                                             "
echo -e "${thinline}"                                                                     
echo -e " ${LILA}GitHub Repository: ${NORMAL}${GITHUB_SERVER_URL}/${GITHUB_REPOSITORY}      "
echo -e "                                                                                                             "
echo -e " ${LILA}GitHub Pages: ${NORMAL}https://dynatrace-wwse.github.io/${RepositoryName}    "
echo -e "                                                                                                             "
echo -e " ${LILA}Dynatrace Tenant: ${NORMAL}${DT_TENANT}"
echo -e "                                                                                                             "
...
echo -e "  ${LILA}Mkdocs (local):${RESET} ${LAB_GUIDE_URL} " 
